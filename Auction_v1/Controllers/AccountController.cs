...
namespace Auction_v1.Controllers
{
    public class AccountController : Controller
    {
        ...
        public void SendVerificationLinkEmail(string emailID, string activationCode)
        {
            ...
            var fromEmail = new MailAddress("projectjohn756@gmail.com", "john project");
            var toEmail = new MailAddress(emailID);
            var fromEmailPassword = "aknh371#j"; 
            string subject = "Your account is successfully created!";

            string body = "<br/><br/>We are excited to tell you that your Online Auction account is" +
